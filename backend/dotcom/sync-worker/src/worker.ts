...
export { AnnotatorDurableObject } from './annotatorDurableObject'
...
export function isAllowedOrigin(origin: string) {
	...
	if (origin.endsWith('.annotator.com')) return origin
	if (origin.endsWith('-annotator.vercel.app')) return origin
	return undefined
}
