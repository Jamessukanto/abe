...
export function getAssetUrls(opts) {
	...
	return {
		fonts: {
			annotator_mono_bold: formatAssetUrl('./fonts/IBMPlexMono-Bold.woff2', opts),
			annotator_mono_italic_bold: formatAssetUrl('./fonts/IBMPlexMono-BoldItalic.woff2', opts),
			annotator_mono: formatAssetUrl('./fonts/IBMPlexMono-Medium.woff2', opts),
			annotator_mono_italic: formatAssetUrl('./fonts/IBMPlexMono-MediumItalic.woff2', opts),
			annotator_sans_bold: formatAssetUrl('./fonts/IBMPlexSans-Bold.woff2', opts),
			annotator_sans_italic_bold: formatAssetUrl('./fonts/IBMPlexSans-BoldItalic.woff2', opts),
			annotator_sans: formatAssetUrl('./fonts/IBMPlexSans-Medium.woff2', opts),
			annotator_sans_italic: formatAssetUrl('./fonts/IBMPlexSans-MediumItalic.woff2', opts),
			annotator_serif_bold: formatAssetUrl('./fonts/IBMPlexSerif-Bold.woff2', opts),
			annotator_serif_italic_bold: formatAssetUrl('./fonts/IBMPlexSerif-BoldItalic.woff2', opts),
			annotator_serif: formatAssetUrl('./fonts/IBMPlexSerif-Medium.woff2', opts),
			annotator_serif_italic: formatAssetUrl('./fonts/IBMPlexSerif-MediumItalic.woff2', opts),
			annotator_draw_bold: formatAssetUrl('./fonts/Shantell_Sans-Informal_Bold.woff2', opts),
			annotator_draw_italic_bold: formatAssetUrl(
				'./fonts/Shantell_Sans-Informal_Bold_Italic.woff2',
				opts
			),
			annotator_draw: formatAssetUrl('./fonts/Shantell_Sans-Informal_Regular.woff2', opts),
