...
export function getAssetUrlsByImport(opts) {
	...
	return {
		fonts: {
			annotator_mono_bold: formatAssetUrl(fontsIBMPlexMonoBoldWoff2, opts),
			annotator_mono_italic_bold: formatAssetUrl(fontsIBMPlexMonoBoldItalicWoff2, opts),
			annotator_mono: formatAssetUrl(fontsIBMPlexMonoMediumWoff2, opts),
			annotator_mono_italic: formatAssetUrl(fontsIBMPlexMonoMediumItalicWoff2, opts),
			annotator_sans_bold: formatAssetUrl(fontsIBMPlexSansBoldWoff2, opts),
			annotator_sans_italic_bold: formatAssetUrl(fontsIBMPlexSansBoldItalicWoff2, opts),
			annotator_sans: formatAssetUrl(fontsIBMPlexSansMediumWoff2, opts),
			annotator_sans_italic: formatAssetUrl(fontsIBMPlexSansMediumItalicWoff2, opts),
			annotator_serif_bold: formatAssetUrl(fontsIBMPlexSerifBoldWoff2, opts),
			annotator_serif_italic_bold: formatAssetUrl(fontsIBMPlexSerifBoldItalicWoff2, opts),
			annotator_serif: formatAssetUrl(fontsIBMPlexSerifMediumWoff2, opts),
			annotator_serif_italic: formatAssetUrl(fontsIBMPlexSerifMediumItalicWoff2, opts),
			annotator_draw_bold: formatAssetUrl(fontsShantellSansInformalBoldWoff2, opts),
			annotator_draw_italic_bold: formatAssetUrl(fontsShantellSansInformalBoldItalicWoff2, opts),
			annotator_draw: formatAssetUrl(fontsShantellSansInformalRegularWoff2, opts),
			annotator_draw_italic: formatAssetUrl(fontsShantellSansInformalRegularItalicWoff2, opts),
		},
		icons: {
