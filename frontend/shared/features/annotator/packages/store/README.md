...
`@annotator/store` is a library for creating and managing data. In this library, a "record" is an object that is stored under a typed id.

`@annotator/store` is used by [annotator](https://www.annotator.com) to store its data. It is designed to be used with [@annotator/state](https://github.com/annotator/annotator/tree/main/packages/state).
...
This project is licensed under the MIT License found [here](https://github.com/annotator/annotator/blob/main/packages/store/LICENSE.md). The annotator SDK is provided under the [annotator license](https://github.com/annotator/annotator/blob/main/LICENSE.md).
