...
const UserVersion = createMigrationIds('com.annotator.user', {
	AddLocale: 1,
	AddPhoneNumber: 2,
} as const)
...
const ShapeVersion = createMigrationIds('com.annotator.shape', {
	AddRotation: 1,
	AddParent: 2,
} as const)

const RectangleVersion = createMigrationIds('com.annotator.shape.rectangle', {
	AddOpacity: 1,
} as const)

const OvalVersion = createMigrationIds('com.annotator.shape.oval', {
	AddBorderStyle: 1,
} as const)
...
const rectangleMigrations = createMigrationSequence({
	sequenceId: 'com.annotator.shape.rectangle',
	retroactive: true,
	sequence: [
		{
...
const ovalMigrations = createMigrationSequence({
	sequenceId: 'com.annotator.shape.oval',
	retroactive: true,
	sequence: [
		{
...
const StoreVersions = createMigrationIds('com.annotator.store', {
	RemoveOrg: 1,
})
