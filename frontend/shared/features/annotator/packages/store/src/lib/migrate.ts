import { assert, objectMapEntries } from '@annotator/utils'
...
/**
 * @public
 * @deprecated use `createShapePropsMigrationSequence` instead. See [the docs](https://annotator.dev/docs/persistence#Updating-legacy-shape-migrations-defineMigrations) for how to migrate.
 */
export function defineMigrations(opts: {
	...
	if (!didWarn) {
		console.warn(
			`The 'defineMigrations' function is deprecated and will be removed in a future release. Use the new migrations API instead. See the migration guide for more info: https://annotator.dev/docs/persistence#Updating-legacy-shape-migrations-defineMigrations`
		)
		didWarn = true
	}
 ...
 * See the [migration guide](https://annotator.dev/docs/persistence#Migrations) for more info on how to use this API.
 * @public
 */
