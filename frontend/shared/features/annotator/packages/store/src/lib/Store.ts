import { Atom, Reactor, Signal, atom, computed, reactor, transact } from '@annotator/state'
import {
	WeakCache,
	assert,
	filterEntries,
...
export class Store<R extends UnknownRecord = UnknownRecord, Props = unknown> {
	...
	/**
	 * @deprecated use `getSnapshot` from the 'annotator' package instead.
	 */
	getSnapshot(scope: RecordScope | 'all' = 'document') {
		console.warn(
			'[annotator] `Store.getSnapshot` is deprecated and will be removed in a future release. Use `getSnapshot` from the `annotator` package instead.'
		)
	...
	/**
	 * @public
	 * @deprecated use `loadSnapshot` from the 'annotator' package instead.
	 */
	loadSnapshot(snapshot: StoreSnapshot<R>) {
		console.warn(
			"[annotator] `Store.loadSnapshot` is deprecated and will be removed in a future release. Use `loadSnapshot` from the 'annotator' package instead."
		)
