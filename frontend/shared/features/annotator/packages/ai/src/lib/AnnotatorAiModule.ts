...
import { AnnotatorAiTransformConstructor } from './annotatorAiTransform'
...
/**
 * The AI manager for Annotator. This class is used to produce prompts for the AI
...
export class AnnotatorAiModule {
	constructor(public readonly opts = {} as AnnotatorAiModuleOptions) {}
