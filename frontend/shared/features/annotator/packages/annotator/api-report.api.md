## API Report File for "annotator"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { Atom } from '@annotator/editor';
import { BaseBoxShapeTool } from '@annotator/editor';
import { BaseBoxShapeUtil } from '@annotator/editor';
import { BindingOnChangeOptions } from '@annotator/editor';
import { BindingOnCreateOptions } from '@annotator/editor';
import { BindingOnShapeChangeOptions } from '@annotator/editor';
import { BindingOnShapeIsolateOptions } from '@annotator/editor';
import { BindingUtil } from '@annotator/editor';
import { Box } from '@annotator/editor';
import { Circle2d } from '@annotator/editor';
import { ComponentType } from 'react';
import { CSSProperties } from 'react';
import { Editor } from '@annotator/editor';
import { Extension } from '@tiptap/core';
import { Extensions } from '@tiptap/core';
import { Geometry2d } from '@annotator/editor';
import { Geometry2dFilters } from '@annotator/editor';
import { Geometry2dOptions } from '@annotator/editor';
import { Group2d } from '@annotator/editor';
import { HandleSnapGeometry } from '@annotator/editor';
import { IndexKey } from '@annotator/editor';
import { JsonObject } from '@annotator/editor';
import { JSX as JSX_2 } from 'react/jsx-runtime';
import { LANGUAGES } from '@annotator/editor';
import { MigrationFailureReason } from '@annotator/editor';
import { MigrationSequence } from '@annotator/editor';
import { NamedExoticComponent } from 'react';
import { Node as Node_2 } from '@tiptap/pm/model';
import { PerfectDashTerminal } from '@annotator/editor';
import { Polygon2d } from '@annotator/editor';
import { Polyline2d } from '@annotator/editor';
import * as React_2 from 'react';
import { default as React_3 } from 'react';
import { ReactElement } from 'react';
import { ReactNode } from 'react';
import { ReadonlySharedStyleMap } from '@annotator/editor';
import { RecordProps } from '@annotator/editor';
import { Rectangle2d } from '@annotator/editor';
import { RecursivePartial } from '@annotator/editor';
import { RefObject } from 'react';
import { Result } from '@annotator/editor';
import { RichTextFontVisitorState } from '@annotator/editor';
import { SerializedSchema } from '@annotator/editor';
import { ShapeUtil } from '@annotator/editor';
import { ShapeWithCrop } from '@annotator/editor';
import { SharedStyle } from '@annotator/editor';
import { StateNode } from '@annotator/editor';
import { StyleProp } from '@annotator/editor';
import { SvgExportContext } from '@annotator/editor';
import { SVGProps } from 'react';
import { TiptapEditor } from '@annotator/editor';
import { TLAnyBindingUtilConstructor } from '@annotator/editor';
import { TLAnyShapeUtilConstructor } from '@annotator/editor';
import { TLArrowBinding } from '@annotator/editor';
import { TLArrowBindingProps } from '@annotator/editor';
import { TLArrowShape } from '@annotator/editor';
import { TLArrowShapeArrowheadStyle } from '@annotator/editor';
import { TLArrowShapeProps } from '@annotator/editor';
import { TLAsset } from '@annotator/editor';
import { TLAssetId } from '@annotator/editor';
import { TLBookmarkAsset } from '@annotator/editor';
import { TLBookmarkShape } from '@annotator/editor';
import { TLBookmarkShapeProps } from '@annotator/editor';
import { TLClickEventInfo } from '@annotator/editor';
import { TLContent } from '@annotator/editor';
import { TLCropInfo } from '@annotator/editor';
import { TLDefaultColorStyle } from '@annotator/editor';
import { TLDefaultColorTheme } from '@annotator/editor';
import { TLDefaultColorThemeColor } from '@annotator/editor';
import { TLDefaultDashStyle } from '@annotator/editor';
import { TLDefaultFillStyle } from '@annotator/editor';
import { TLDefaultFontStyle } from '@annotator/editor';
import { TLDefaultHorizontalAlignStyle } from '@annotator/editor';
import { TLDefaultSizeStyle } from '@annotator/editor';
import { TLDefaultTextAlignStyle } from '@annotator/editor';
import { TLDefaultVerticalAlignStyle } from '@annotator/editor';
import { TLDragShapesOutInfo } from '@annotator/editor';
import { TLDragShapesOverInfo } from '@annotator/editor';
import { AnnotatorEditorBaseProps } from '@annotator/editor';
import { AnnotatorEditorStoreProps } from '@annotator/editor';
import { AnnotatorShape } from '@annotator/editor';
import { AnnotatorShapeProps } from '@annotator/editor';
import { AnnotatorShapeSegment } from '@annotator/editor';
import { TLEditorComponents } from '@annotator/editor';
import { TLEditorSnapshot } from '@annotator/editor';
import { TLEmbedShape } from '@annotator/editor';
import { TLEmbedShapeProps } from '@annotator/editor';
import { TLExportType } from '@annotator/editor';
import { TLFileExternalAsset } from '@annotator/editor';
import { TLFontFace } from '@annotator/editor';
import { TLFrameShape } from '@annotator/editor';
import { TLFrameShapeProps } from '@annotator/editor';
import { TLGeometryOpts } from '@annotator/editor';
import { TLGeoShape } from '@annotator/editor';
import { TLGeoShapeGeoStyle } from '@annotator/editor';
import { TLGeoShapeProps } from '@annotator/editor';
import { TLHandle } from '@annotator/editor';
import { TLHandleDragInfo } from '@annotator/editor';
import { TLHandlesProps } from '@annotator/editor';
import { TLHighlightShape } from '@annotator/editor';
import { TLHighlightShapeProps } from '@annotator/editor';
import { TLImageAsset } from '@annotator/editor';
import { TLImageExportOptions } from '@annotator/editor';
import { TLImageShape } from '@annotator/editor';
import { TLImageShapeProps } from '@annotator/editor';
import { TLKeyboardEventInfo } from '@annotator/editor';
import { TLLineShape } from '@annotator/editor';
import { TLLineShapePoint } from '@annotator/editor';
import { TLLineShapeSplineStyle } from '@annotator/editor';
import { TLNoteShape } from '@annotator/editor';
import { TLNoteShapeProps } from '@annotator/editor';
import { TLOpacityType } from '@annotator/editor';
import { TLPageId } from '@annotator/editor';
import { TLParentId } from '@annotator/editor';
import { TLPointerEventInfo } from '@annotator/editor';
import { TLPropsMigrations } from '@annotator/editor';
import { TLResizeInfo } from '@annotator/editor';
import { TLRichText } from '@annotator/editor';
import { TLSchema } from '@annotator/editor';
import { TLScribbleProps } from '@annotator/editor';
import { TLSelectionForegroundProps } from '@annotator/editor';
import { TLShape } from '@annotator/editor';
import { TLShapeCrop } from '@annotator/editor';
import { TLShapeId } from '@annotator/editor';
import { TLShapePartial } from '@annotator/editor';
import { TLShapeUtilCanBeLaidOutOpts } from '@annotator/editor';
import { TLShapeUtilCanBindOpts } from '@annotator/editor';
import { TLShapeUtilCanvasSvgDef } from '@annotator/editor';
import { TLShapeUtilConstructor } from '@annotator/editor';
import { TLStateNodeConstructor } from '@annotator/editor';
import { TLStore } from '@annotator/editor';
import { TLStoreSnapshot } from '@annotator/editor';
import { TLTextOptions } from '@annotator/editor';
import { TLTextShape } from '@annotator/editor';
import { TLUrlExternalAsset } from '@annotator/editor';
import { TLVideoAsset } from '@annotator/editor';
import { TLVideoShape } from '@annotator/editor';
import { UnknownRecord } from '@annotator/editor';
import { Vec } from '@annotator/editor';
import { VecLike } from '@annotator/editor';
import { VecModel } from '@annotator/editor';
...
export const DEFAULT_EMBED_DEFINITIONS: readonly [{
    ...
    readonly height: 500;
    readonly hostnames: readonly ["beta.annotator.com", "annotator.com", "localhost:3000"];
    readonly minHeight: 300;
    readonly minWidth: 300;
    readonly overridePermissions: {
        readonly 'allow-top-navigation': true;
    };
    readonly title: "annotator";
    readonly toEmbedUrl: (url: string) => string | undefined;
    readonly type: "annotator";
    readonly width: 720;
}, {
    readonly doesResize: true;
    readonly fromEmbedUrl: (url: string) => string | undefined;
...
// @public (undocumented)
export function defaultHandleExternalAnnotatorContent(editor: Editor, { point, content }: {
    content: TLContent;
    point?: VecLike;
}): Promise<void>;
...
export class DrawShapeUtil extends ShapeUtil<AnnotatorShape> {
    // (undocumented)
    component(shape: AnnotatorShape): JSX_2.Element;
    // (undocumented)
    expandSelectionOutlinePx(shape: AnnotatorShape): number;
    // (undocumented)
    getCanvasSvgDefs(): TLShapeUtilCanvasSvgDef[];
    // (undocumented)
    getDefaultProps(): AnnotatorShape['props'];
    // (undocumented)
    getGeometry(shape: AnnotatorShape): Circle2d | Polyline2d;
    // (undocumented)
    getInterpolatedProps(startShape: AnnotatorShape, endShape: AnnotatorShape, t: number): AnnotatorShapeProps;
    // (undocumented)
    hideResizeHandles(shape: AnnotatorShape): boolean;
    // (undocumented)
    hideRotateHandle(shape: AnnotatorShape): boolean;
    // (undocumented)
    hideSelectionBoundsFg(shape: AnnotatorShape): boolean;
    // (undocumented)
    indicator(shape: AnnotatorShape): JSX_2.Element;
    // (undocumented)
    static migrations: TLPropsMigrations;
    // (undocumented)
    onResize(shape: AnnotatorShape, info: TLResizeInfo<AnnotatorShape>): {
        props: {
    ...
    // (undocumented)
    static props: RecordProps<AnnotatorShape>;
    // (undocumented)
    toSvg(shape: AnnotatorShape, ctx: SvgExportContext): JSX_2.Element;
    // (undocumented)
    static type: "draw";
}
...
// @public (undocumented)
export function parseAnnotatorJsonFile({ json, schema, }: {
    json: string;
    schema: TLSchema;
...
// @public (undocumented)
export function serializeAnnotatorJson(editor: Editor): Promise<string>;

// @public (undocumented)
export function serializeAnnotatorJsonBlob(editor: Editor): Promise<Blob>;
...
// @public (undocumented)
export function Annotator(props: AnnotatorProps): JSX_2.Element;

// @public (undocumented)
export const ANNOTATOR_FILE_EXTENSION: ".tldr";

// @public (undocumented)
export function AnnotatorArrowHints(): JSX_2.Element | null;

// @public (undocumented)
export interface AnnotatorBaseProps extends AnnotatorUiProps, AnnotatorEditorBaseProps, TLExternalContentProps {
...
// @public (undocumented)
export function AnnotatorHandles({ children }: TLHandlesProps): JSX_2.Element | null;

// @public
export const AnnotatorImage: NamedExoticComponent<AnnotatorImageProps>;
...
// @public (undocumented)
export function AnnotatorOverlays(): JSX_2.Element | null;

// @public (undocumented)
export type AnnotatorProps = AnnotatorBaseProps & AnnotatorEditorStoreProps;

// @public (undocumented)
export function AnnotatorScribble({ scribble, zoom, color, opacity, className }: TLScribbleProps): JSX_2.Element | null;

// @public (undocumented)
export const AnnotatorSelectionForeground: NamedExoticComponent<TLSelectionForegroundProps>;

// @public (undocumented)
export function AnnotatorShapeIndicators(): JSX_2.Element;

// @public (undocumented)
export const AnnotatorUi: React_3.NamedExoticComponent<AnnotatorUiProps>;

// @public (undocumented)
export function AnnotatorUiA11yProvider({ children }: A11yProviderProps): JSX_2.Element;

// @public (undocumented)
export const AnnotatorUiButton: React_2.ForwardRefExoticComponent<TLUiButtonProps & React_2.RefAttributes<HTMLButtonElement>>;

// @public (undocumented)
export function AnnotatorUiButtonCheck({ checked }: TLUiButtonCheckProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiButtonIcon({ icon, small, invertIcon }: TLUiButtonIconProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiButtonLabel({ children }: TLUiButtonLabelProps): JSX_2.Element;

// @public (undocumented)
export const AnnotatorUiButtonPicker: <T extends string>(props: TLUiButtonPickerProps<T>) => ReactElement;

// @public (undocumented)
export function AnnotatorUiComponentsProvider({ overrides, children, }: TLUiComponentsProviderProps): JSX_2.Element;

// @public (undocumented)
export const AnnotatorUiContextProvider: NamedExoticComponent<TLUiContextProviderProps>;

// @public
export const AnnotatorUiContextualToolbar: ({ children, className, isMousingDown, getSelectionBounds, changeOnlyWhenYChanges, label, }: TLUiContextualToolbarProps) => JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDialogBody({ className, children, style }: TLUiDialogBodyProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDialogCloseButton(): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDialogFooter({ className, children }: TLUiDialogFooterProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDialogHeader({ className, children }: TLUiDialogHeaderProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDialogsProvider({ context, children }: TLUiDialogsProviderProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDialogTitle({ className, children, style }: TLUiDialogTitleProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuCheckboxItem({ children, onSelect, ...rest }: TLUiDropdownMenuCheckboxItemProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuContent({ className, side, align, sideOffset, alignOffset, children, }: TLUiDropdownMenuContentProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuGroup({ className, children }: TLUiDropdownMenuGroupProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuIndicator(): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuItem({ noClose, children }: TLUiDropdownMenuItemProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuRoot({ id, children, modal, debugOpen, }: TLUiDropdownMenuRootProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuSub({ id, children }: TLUiDropdownMenuSubProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuSubTrigger({ id, label, title, disabled, }: TLUiDropdownMenuSubTriggerProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiDropdownMenuTrigger({ children, ...rest }: TLUiDropdownMenuTriggerProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiEventsProvider({ onEvent, children }: EventsProviderProps): JSX_2.Element;

// @public (undocumented)
export const AnnotatorUiIcon: NamedExoticComponent<TLUiIconProps>;

// @public (undocumented)
export const AnnotatorUiInput: React_2.ForwardRefExoticComponent<TLUiInputProps & React_2.RefAttributes<HTMLInputElement>>;

// @public (undocumented)
export function AnnotatorUiKbd({ children, visibleOnMobileLayout }: TLUiKbdProps): JSX_2.Element | null;

// @public (undocumented)
export function AnnotatorUiMenuActionCheckboxItem({ actionId, ...rest }: TLUiMenuActionCheckboxItemProps): JSX_2.Element | null;

// @public (undocumented)
export function AnnotatorUiMenuActionItem({ actionId, ...rest }: TLUiMenuActionItemProps): JSX_2.Element | null;

// @public (undocumented)
export function AnnotatorUiMenuCheckboxItem<TranslationKey extends string = string, IconType extends string = string>({ id, kbd, label, readonlyOk, onSelect, toggle, disabled, checked, }: TLUiMenuCheckboxItemProps<TranslationKey, IconType>): JSX_2.Element | null;

// @public (undocumented)
export function AnnotatorUiMenuContextProvider({ type, sourceId, children, }: TLUiMenuContextProviderProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiMenuGroup({ id, label, className, children }: TLUiMenuGroupProps): boolean | JSX_2.Element | Iterable<ReactNode> | null | number | string | undefined;

// @public (undocumented)
export function AnnotatorUiMenuItem<TranslationKey extends string = string, IconType extends string = string>({ disabled, spinner, readonlyOk, id, kbd, label, icon, iconLeft, onSelect, noClose, isSelected, }: TLUiMenuItemProps<TranslationKey, IconType>): JSX_2.Element | null;

// @public (undocumented)
export function AnnotatorUiMenuSubmenu<Translation extends string = string>({ id, disabled, label, size, children, }: TLUiMenuSubmenuProps<Translation>): boolean | JSX_2.Element | Iterable<ReactNode> | null | number | string | undefined;

// @public (undocumented)
export function AnnotatorUiMenuToolItem({ toolId, ...rest }: TLUiMenuToolItemProps): JSX_2.Element | null;

// @public (undocumented)
export function AnnotatorUiPopover({ id, children, onOpenChange, open }: TLUiPopoverProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiPopoverContent({ side, children, align, sideOffset, alignOffset, disableEscapeKeyDown, autoFocusFirstButton, }: TLUiPopoverContentProps): JSX_2.Element;

// @public (undocumented)
export function AnnotatorUiPopoverTrigger({ children }: TLUiPopoverTriggerProps): JSX_2.Element;
...
// @public (undocumented)
export const AnnotatorUiSlider: React_3.ForwardRefExoticComponent<TLUiSliderProps & React_3.RefAttributes<HTMLDivElement>>;

// @public (undocumented)
export function AnnotatorUiToastsProvider({ children }: TLUiToastsProviderProps): JSX_2.Element;

// @public (undocumented)
export const AnnotatorUiToolbar: React_3.ForwardRefExoticComponent<TLUiToolbarProps & React_3.RefAttributes<HTMLDivElement>>;

// @public (undocumented)
export const AnnotatorUiToolbarButton: React_3.ForwardRefExoticComponent<TLUiToolbarButtonProps & React_3.RefAttributes<HTMLButtonElement>>;

// @public (undocumented)
export const AnnotatorUiToolbarToggleGroup: ({ children, className, type, ...props }: TLUiToolbarToggleGroupProps) => JSX_2.Element;

// @public (undocumented)
export const AnnotatorUiToolbarToggleItem: ({ children, className, type, value, ...props }: TLUiToolbarToggleItemProps) => JSX_2.Element;

// @internal
export function AnnotatorUiTranslationProvider({ overrides, locale, children, }: TLUiTranslationProviderProps): JSX_2.Element;
...
// @public (undocumented)
export function useAnnotatorUiComponents(): TLUiComponents;
