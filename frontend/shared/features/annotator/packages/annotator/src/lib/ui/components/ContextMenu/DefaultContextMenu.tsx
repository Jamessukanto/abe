import { preventDefault, useContainer, useEditor, useEditorComponents } from '@annotator/editor'
		...
		<_ContextMenu.Root dir="ltr" onOpenChange={handleOpenChange} modal={false}>
			...
			{isOpen && (
				<_ContextMenu.Portal container={container}>
					...
					>
						<AnnotatorUiMenuContextProvider type="context-menu" sourceId="context-menu">
							{content}
