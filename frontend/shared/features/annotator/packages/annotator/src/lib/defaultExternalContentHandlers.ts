...
export function registerDefaultExternalContentHandlers(
	...
	// annotator
	editor.registerExternalContentHandler('annotator', async (externalContent) => {
		return defaultHandleExternalAnnotatorContent(editor, externalContent)
	})
...
/** @public */
export async function defaultHandleExternalAnnotatorContent(
	editor: Editor,
