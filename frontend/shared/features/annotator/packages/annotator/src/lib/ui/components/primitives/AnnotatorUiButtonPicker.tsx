...
import { AnnotatorUiToolbarToggleGroup, AnnotatorUiToolbarToggleItem } from './AnnotatorUiToolbar'
...
/** @public */
export const AnnotatorUiButtonPicker = memo(function AnnotatorUiButtonPicker<T extends string>(
