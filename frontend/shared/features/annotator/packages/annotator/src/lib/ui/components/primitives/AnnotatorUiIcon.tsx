...
/** @public @react */
export const AnnotatorUiIcon = memo(function AnnotatorUiIcon({
	label,
	small,
	invertIcon,
	icon,
...
function AnnotatorUiIconInner({
	...
	useLayoutEffect(() => {
		...
		if (ref?.current) {
			// HACK: Fix for <https://linear.app/annotator/issue/TLD-1700/dragging-around-with-the-handtool-makes-lots-of-requests-for-icons>
