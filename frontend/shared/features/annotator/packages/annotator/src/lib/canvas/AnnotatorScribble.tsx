import { EASINGS, TLScribbleProps, getSvgPathFromPoints } from '@annotator/editor'
import classNames from 'classnames'
import { getStroke } from '../shapes/shared/freehand/getStroke'

/** @public @react */
export function AnnotatorScribble({ scribble, zoom, color, opacity, className }: TLScribbleProps) {
