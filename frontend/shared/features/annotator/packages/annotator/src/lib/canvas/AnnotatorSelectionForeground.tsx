...
import { AnnotatorCropHandles } from './annotatorCropHandles'

/** @public */
export const AnnotatorSelectionForeground = track(function AnnotatorSelectionForeground({
	bounds,
	rotation,
}: TLSelectionForegroundProps) {
