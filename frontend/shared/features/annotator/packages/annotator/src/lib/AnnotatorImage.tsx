...
/** @public */
export interface AnnotatorImageProps extends TLImageExportOptions {
	/**
...
/**
 * A rendered SVG image of a Annotator snapshot.
 *
 * @example
 * ```tsx
 * <AnnotatorImage
 ...
 * @react
 */
export const AnnotatorImage = memo(function AnnotatorImage(props: AnnotatorImageProps) {
