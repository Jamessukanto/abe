...
export const DefaultPageMenu = memo(function DefaultPageMenu() {
	...
	return (
		<AnnotatorUiPopover id="pages" onOpenChange={onOpenChange} open={isOpen}>
			<AnnotatorUiPopoverTrigger data-testid="main.page-menu">
				<AnnotatorUiButton
					type="menu"
				...
				>
					...
					<AnnotatorUiButtonIcon icon="chevron-down" small />
				</AnnotatorUiButton>
			</AnnotatorUiPopoverTrigger>
			<AnnotatorUiPopoverContent
				side="bottom"
					...
					<div className="tlui-page-menu__header">
						...
						{!isReadonlyMode && (
							<div className="tlui-buttons__horizontal">
								...
								>
									<AnnotatorUiButtonIcon icon="plus" />
								</AnnotatorUiButton>
							</div>
						)}
					</div>
