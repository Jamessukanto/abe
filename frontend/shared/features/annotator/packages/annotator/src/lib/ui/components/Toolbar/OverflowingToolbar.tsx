		...
		<>
			...
			>
				<div id={`${id}_main`} ref={mainToolsRef} className="tlui-toolbar__tools__list">
					<AnnotatorUiMenuContextProvider type="toolbar" sourceId="toolbar">
						{children}
					...
					<IsInOverflowContext.Provider value={true}>
						<AnnotatorUiPopover id={popoverId} open={isOpen} onOpenChange={setIsOpen}>
							<AnnotatorUiPopoverTrigger>
								...
								>
									<AnnotatorUiButtonIcon icon="chevron-up" />
								</AnnotatorUiToolbarButton>
							</AnnotatorUiPopoverTrigger>
							<AnnotatorUiPopoverContent side="top" align="center">
								<AnnotatorUiToolbar
								...
								>
									<AnnotatorUiMenuContextProvider type="toolbar-overflow" sourceId="toolbar">
										{children}
									</AnnotatorUiMenuContextProvider>
								</AnnotatorUiToolbar>
							</AnnotatorUiPopoverContent>
