...
import { AnnotatorUiToolbar } from './AnnotatorUiToolbar'
 ...
 * @public @react
 */
export const AnnotatorUiContextualToolbar = ({
	children,
	className,
	isMousingDown,
	getSelectionBounds,
	...
	return (
		...
		>
			<AnnotatorUiToolbar className="tlui-menu tlui-buttons__horizontal" label={label}>
				{children}
			</AnnotatorUiToolbar>
		</div>
	)
