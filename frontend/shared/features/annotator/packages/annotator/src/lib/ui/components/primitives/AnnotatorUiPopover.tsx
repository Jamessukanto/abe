...
/** @public @react */
export function AnnotatorUiPopover({ id, children, onOpenChange, open }: TLUiPopoverProps) {
...
/** @public @react */
export function AnnotatorUiPopoverTrigger({ children }: TLUiPopoverTriggerProps) {
	return (
...
/** @public @react */
export function AnnotatorUiPopoverContent({
	side,
	children,
	align = 'center',
	sideOffset = 8,
