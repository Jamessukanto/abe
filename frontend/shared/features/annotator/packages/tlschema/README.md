...
Type definitions, schema migrations, and other type metadata for the annotator editor's default persisted data.
...
This project is licensed under the MIT License found [here](https://github.com/annotator/annotator/blob/main/packages/tlschema/LICENSE.md). The annotator SDK is provided under the [annotator license](https://github.com/annotator/annotator/blob/main/LICENSE.md).
