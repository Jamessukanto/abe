 ...
 *
 * For example, {@link DefaultColorStyle} is a style prop used by annotator's default shapes to set
 * their color. If you try selecting several shapes on annotator.com and changing their color, you'll
 ...
 * and {@link StyleProp.defineEnum}) or using annotator's default ones, like {@link DefaultColorStyle}.
 ...
 * {@link https://github.com/annotator/annotator/tree/main/apps/examples | custom styles example}
 * for more.
 *
 * @public
 */
export class StyleProp<Type> implements T.Validatable<Type> {
	 ...
	 * ```ts
	 * import {T} from '@annotator/validate'
	 * import {StyleProp} from '@annotator/tlschema'
	 *
