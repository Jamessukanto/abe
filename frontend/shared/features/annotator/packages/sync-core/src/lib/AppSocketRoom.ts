import type { StoreSchema, UnknownRecord } from '@annotator/store'
import { TLStoreSnapshot, createTLSchema } from '@annotator/tlschema'
import { objectMapValues, structuredClone } from '@annotator/utils'
import { RoomSessionState } from './RoomSession'
import { ServerSocketAdapter, WebSocketMinimal } from './ServerSocketAdapter'
import { TLSyncErrorCloseEventReason } from './AppSyncClient'
import { RoomSnapshot, RoomStoreMethods, TLSyncRoom } from './AppSyncRoom'
...
/** @public */
export class AppSocketRoom<R extends UnknownRecord = UnknownRecord, SessionMeta = void> {
	...
	constructor(
		public readonly opts: {
			...
			// eslint-disable-next-line @typescript-eslint/method-signature-style
			onSessionRemoved?: (
				room: AppSocketRoom<R, SessionMeta>,
	 ...
	 * You can store this and load it later on when initializing a AppSocketRoom.
	 * You can also pass a snapshot to {@link AppSocketRoom#loadSnapshot} if you need to revert to a previous state.
