 ...
 * @public
 */
export interface AppInstance extends BaseRecord<'instance', AppInstanceId> {
...
} as const satisfies { [K in keyof AppInstance]: boolean }

/** @internal */
export function pluckPreservingValues(val?: AppInstance | null): null | Partial<AppInstance> {
	return val
		? (filterEntries(val, (key) => {
				return shouldKeyBePreservedBetweenSessions[key as keyof AppInstance]
			}) as Partial<AppInstance>)
		: null
}

/** @public */
export type AppInstanceId = RecordId<AppInstance>

/** @public */
export const instanceIdValidator = idValidator<AppInstanceId>('instance')
...
export function createInstanceRecordType(stylesById: Map<string, StyleProp<unknown>>) {
	...
	const instanceTypeValidator: T.Validator<AppInstance> = T.model(
		'instance',
		T.object({
			typeName: T.literal('instance'),
			id: idValidator<AppInstanceId>('instance'),
			...
			duplicateProps: T.object({
				shapeIds: T.arrayOf(idValidator<AppShapeId>('shape')),
				offset: T.object({
					x: T.number,
					y: T.number,
				}),
	...
	return createRecordType<AppInstance>('instance', {
		...
		(): Omit<AppInstance, 'typeName' | 'id' | 'currentPageId'> => ({
...
/** @public */
export const instanceVersions = createMigrationIds('com.annotator.instance', {
...
export const instanceMigrations = createRecordMigrationSequence({
	sequenceId: 'com.annotator.instance',
	recordType: 'instance',
	sequence: [
		{
...
/** @public */
export const AppINSTANCE_ID = 'instance:instance' as AppInstanceId
