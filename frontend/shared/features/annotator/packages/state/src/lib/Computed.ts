 ...
 * @public
 */
export const UNINITIALIZED = Symbol.for('com.annotator.state/UNINITIALIZED')
/**
...
function computedMethodTc39Decorator<This extends object, Value>(
	...
	const derivationKey = Symbol.for('__@annotator/state__computed__' + String(context.name))
...
export function getComputedInstance<Obj extends object, Prop extends keyof Obj>(
	...
	const key = Symbol.for('__@annotator/state__computed__' + propertyName.toString())
