...
import { exhaustiveSwitchError } from '@annotator/utils'

/**
 * The value of a particular {@link @annotator/tlschema#StyleProp}.
 *
...
/**
 * A map of {@link @annotator/tlschema#StyleProp | StyleProps} to their {@link SharedStyle} values. See
