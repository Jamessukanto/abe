...
import { getDefaultTranslationLocale } from '@annotator/tlschema'
import { getFromLocalStorage, setInLocalStorage, structuredClone, uniqueId } from '@annotator/utils'
import { T } from '@annotator/validate'

const USER_DATA_KEY = 'ANNOTATOR_USER_DATA_v3'
...
export interface TLUserPreferences {
	...
	name?: string | null
	color?: string | null
	// N.B. These are duplicated in AnnotatorAppUser.
	locale?: string | null
...
const channel =
	typeof BroadcastChannel !== 'undefined' && !isTest
		? new BroadcastChannel('annotator-user-sync')
		: null
...
const broadcastEventKey = 'annotator-user-preferences-change' as const
