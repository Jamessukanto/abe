 ...
 * safe: if annotator is rendered twice, or an SVG export is taking place, the IDs will clash and the
 ...
 * the same ID across multiple components, but unique within a single annotator/editor instance.
 *
 * @public
 */
