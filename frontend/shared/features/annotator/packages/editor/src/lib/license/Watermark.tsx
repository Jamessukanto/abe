...
const WatermarkInner = memo(function WatermarkInner({ src }: { src: string }) {
	...
	const url = 'https://annotator.dev/?utm_source=dotcom&utm_medium=organic&utm_campaign=watermark'
...
The annotator watermark is part of annotator's license. It is shown for unlicensed
or "licensed-with-watermark" users. By using this library, you agree to
preserve the watermark's behavior, keeping it visible, unobscured, and
available to user-interaction.

To remove the watermark, please purchase a license at annotator.dev.
*/
