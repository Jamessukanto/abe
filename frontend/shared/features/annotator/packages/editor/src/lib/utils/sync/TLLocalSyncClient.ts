import { Signal, transact } from '@annotator/state'
import { RecordsDiff, SerializedSchema, UnknownRecord, squashRecordDiffs } from '@annotator/store'
import { TLStore } from '@annotator/tlschema'
...
export class TLLocalSyncClient {
	...
	constructor(
		...
		public readonly channel = new BC(`annotator-tab-sync-${persistenceKey}`)
	) {
