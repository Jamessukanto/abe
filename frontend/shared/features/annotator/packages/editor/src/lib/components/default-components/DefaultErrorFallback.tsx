...
import { noop } from '@annotator/utils'
...
const BASE_ERROR_URL = 'https://github.com/annotator/annotator/issues/new'
...
export const DefaultErrorFallback: TLErrorFallbackComponent = ({ error, editor }) => {
	...
	url.searchParams.set(
		'body',
		`Hey, I ran into an error while using annotator:
			...
			>
				{shouldShowResetConfirmation ? (
					...
					<>
						...
						<p>
							If the issue continues after refreshing, you may need to reset the annotator data stored
							on your device.
						</p>
						<p>
						...
						{process.env.NODE_ENV !== 'production' && (
							<p>
								...
								<a href="https://discord.annotator.com/?utm_source=sdk&utm_medium=organic&utm_campaign=error-screen">
									Discord
								</a>
								.
							</p>
