import { Computed, RESET_VALUE, computed, isUninitialized } from '@annotator/state'
import { TLBinding, TLShapeId, TLUnknownBinding } from '@annotator/tlschema'
import { objectMapValues } from '@annotator/utils'
import { Editor } from '../Editor'

type TLBindingsIndex = Map<TLShapeId, TLBinding[]>

function fromScratch(bindingsQuery: Computed<TLUnknownBinding[], unknown>) {
