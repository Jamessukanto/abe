import { RecordProps, TLPropsMigrations, TLShape, TLUnknownBinding } from '@annotator/tlschema'
 ...
 * now be in an inconsistent state. For example, annotator's arrow shape depends on the binding to know
