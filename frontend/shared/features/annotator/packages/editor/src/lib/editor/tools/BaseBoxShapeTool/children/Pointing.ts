import { TLShape, createShapeId } from '@annotator/tlschema'
import { structuredClone } from '@annotator/utils'
			...
			this.editor.setCurrentTool(
				'select.resizing',
				{
					...
					onCreate: parent.onCreate
						...
						: undefined,
				} /** satisfies ResizingInfo, defined in main annotator package 😧 */
			)
		}
	}
