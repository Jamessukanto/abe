...
export abstract class ShapeUtil<Shape extends TLUnknownShape = TLUnknownShape> {
	 ...
	 * 2. Styles. Each {@link @annotator/tlschema#StyleProp} in the props can be set on many shapes at
	 *    once, and will be remembered from one shape to the next.
	 *
	 * @example
	 * ```tsx
	 * import {T, TLBaseShape, TLDefaultColorStyle, DefaultColorStyle, ShapeUtil} from 'annotator'
	 *
	 ...
	 *     static props = {
	 *         // we use annotator's built-in color style:
