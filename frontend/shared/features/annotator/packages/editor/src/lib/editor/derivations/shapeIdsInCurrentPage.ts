import { computed, isUninitialized, RESET_VALUE, withDiff } from '@annotator/state'
import { IncrementalSetConstructor } from '@annotator/store'
import {
	isPageId,
	isShape,
	isShapeId,
 ...
 *
 * @param store - The annotator store.
