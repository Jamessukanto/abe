import { computed, EMPTY_ARRAY, transact } from '@annotator/state'
import { AtomMap } from '@annotator/store'
...
export interface TLFontFaceSource {
	 ...
	 * {@link annotator#TLEditorAssetUrls.fonts}, the value from there will be used instead.
	 */
	url: string
	format?: string
	tech?: string
