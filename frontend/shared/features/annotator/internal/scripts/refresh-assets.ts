...
const FONT_MAPPING: Record<string, string> = {
	'IBMPlexMono-Medium': 'annotator_mono',
	'IBMPlexMono-MediumItalic': 'annotator_mono_italic',
	'IBMPlexMono-Bold': 'annotator_mono_bold',
	'IBMPlexMono-BoldItalic': 'annotator_mono_italic_bold',
	'IBMPlexSerif-Medium': 'annotator_serif',
	'IBMPlexSerif-MediumItalic': 'annotator_serif_italic',
	'IBMPlexSerif-Bold': 'annotator_serif_bold',
	'IBMPlexSerif-BoldItalic': 'annotator_serif_italic_bold',
	'IBMPlexSans-Medium': 'annotator_sans',
	'IBMPlexSans-MediumItalic': 'annotator_sans_italic',
	'IBMPlexSans-Bold': 'annotator_sans_bold',
	'IBMPlexSans-BoldItalic': 'annotator_sans_italic_bold',
	'Shantell_Sans-Informal_Regular': 'annotator_draw',
	'Shantell_Sans-Informal_Regular_Italic': 'annotator_draw_italic',
	'Shantell_Sans-Informal_Bold': 'annotator_draw_bold',
	'Shantell_Sans-Informal_Bold_Italic': 'annotator_draw_italic_bold',
}
...
async function copyIcons() {
	...
	await writeCodeFile(
		...
		'typescript',
		join(REPO_ROOT, 'packages', 'annotator', 'src', 'lib', 'ui', 'icon-types.ts'),
		iconTypeFile
	)
...
async function copyEmbedIcons() {
	...
	// Skip if the embed-icons directory doesn't exist
	if (!existsSync(sourceFolderPath)) {
		nicelog('Skipping embed-icons copy - directory does not exist')
		return
	}
...
async function createVersionFiles() {
	const packageJson = await readJsonIfExists(join(REPO_ROOT, 'packages', 'annotator', 'package.json'))
	...
	await writeCodeFile(
		'internal/scripts/refresh-assets.ts',
		'typescript',
		join(REPO_ROOT, 'packages', 'annotator', 'src', 'lib', 'ui', 'version.ts'),
		file
	)
}
