...
async function buildLibrary({
	...
	if (process.env.ANNOTATOR_BEMO_URL) {
		define['process.env.ANNOTATOR_BEMO_URL'] = JSON.stringify(process.env.ANNOTATOR_BEMO_URL)
	}
	...
	define['globalThis.ANNOTATOR_LIBRARY_NAME'] = JSON.stringify(info.name)
	define['globalThis.ANNOTATOR_LIBRARY_VERSION'] = JSON.stringify(info.version)
	define['globalThis.ANNOTATOR_LIBRARY_MODULES'] = JSON.stringify(info.moduleSystem)
	define['globalThis.ANNOTATOR_LIBRARY_IS_BUILD'] = JSON.stringify(true)
