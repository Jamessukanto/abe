...
const GoBackLink = () => {
	...
	return (
		<Link to={'/'} target={inIframe ? '_blank' : '_self'}>
			{inIframe ? <F id="open-annotator" defaultMessage="Open annotator." /> : <F id="back-to-annotator" defaultMessage="Back to annotator." />}
		</Link>
	)
}
...
export function ErrorPage({
	...
	return (
		...
		<IntlProvider 
			...
			locale="en" 
			messages={{
				'open-annotator': 'Open annotator.',
				'back-to-annotator': 'Back to annotator.'
			}}
		>
