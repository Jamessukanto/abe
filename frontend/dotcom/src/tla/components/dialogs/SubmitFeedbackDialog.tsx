...
import { SubmitFeedbackRequestBody } from '@annotator/dotcom-shared'
...
const messages = defineMessages({
	...
	thanks: { defaultMessage: 'Thanks for helping us improve annotator!' },
})

const descriptionKey = 'annotator-feedback-description'
	...
	return (
		<div className={styles.dialogContainer}>
			...
			<AnnotatorUiDialogBody className={styles.dialogBody}>
				<p>
					<F defaultMessage="Have a bug, issue, or idea for annotator? Let us know!" />
				</p>
				<ul>
					<li>
						<ExternalLink to="https://discord.annotator.com/?utm_source=dotcom&utm_medium=organic&utm_campaign=dotcom-feedback">
							<F defaultMessage="Chat with us on Discord" />
						</ExternalLink>
					</li>
					<li>
						<ExternalLink to="https://github.com/annotator/annotator/issues">
	...
	return (
		<>
			...
			<AnnotatorUiDialogBody className={styles.dialogBody}>
				<p>
					<F
						defaultMessage="Have a bug, issue, or idea for annotator? Let us know! Fill out this form and we will follow up over email if needed. You can also <discord>chat with us on Discord</discord> or <github>submit an issue on GitHub</github>."
						values={{
							discord: (chunks) => {
								return (
									<ExternalLink to="https://discord.annotator.com/?utm_source=dotcom&utm_medium=organic&utm_campaign=dotcom-feedback">
							...
							github: (chunks) => {
								return (
									<ExternalLink to="https://github.com/annotator/annotator/issues">{chunks}</ExternalLink>
								)
							},
						}}
					/>
			...
			<AnnotatorUiDialogFooter className="tlui-dialog__footer__actions">
				...
				<AnnotatorUiButton type="primary" onClick={onSubmit}>
					<AnnotatorUiButtonLabel>
