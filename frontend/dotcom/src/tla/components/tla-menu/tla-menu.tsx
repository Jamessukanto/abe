...
import { AnnotatorUiButton, AnnotatorUiIcon } from 'annotator'
			...
			<TlaTooltipRoot>
				<TlaTooltipTrigger dir="ltr" asChild>
					{href ? (
						...
						>
							<AnnotatorUiIcon label={helpMsg} icon="help-circle" small />
						</a>
					) : (
						<AnnotatorUiButton type="icon" className={styles.menuInfoTrigger}>
							<AnnotatorUiIcon label={helpMsg} icon="help-circle" small />
						</AnnotatorUiButton>
					)}
				</TlaTooltipTrigger>
