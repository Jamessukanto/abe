import { TlaFile } from '@annotator/dotcom-shared'
import { useCallback } from 'react'
import { useEditor, useValue } from 'annotator'
import { routes } from '../../../../routeDefs'
import { useApp } from '../../../hooks/useAppState'
import { useEditorDeepLink } from '../../../hooks/useDeepLink'
import { useIsFileOwner } from '../../../hooks/useIsFileOwner'
import { useAnnotatorUser } from '../../../hooks/useUser'
...
function TlaSharedToggle({ isShared, fileId }: { isShared: boolean; fileId: string }) {
	...
	const learnMoreUrl = 'https://annotator.notion.site/Sharing-1283e4c324c080a69618ff37eb3fc98f'
	return (
		<TlaMenuControl>
			<TlaMenuControlLabel>
