...
export function TlaExportTab() {
	...
	const onChange = useCallback(
		<T extends keyof AnnotatorAppSessionState['exportSettings']>(
			key: T,
			value: AnnotatorAppSessionState['exportSettings'][T]
		) => {
			if (app) {
...
function ExportPaddingToggle({
	...
	value: AnnotatorAppSessionState['exportSettings']['exportPadding']
	onChange(
		key: 'exportPadding',
		value: AnnotatorAppSessionState['exportSettings']['exportPadding']
	): void
...
function ExportBackgroundToggle({
	...
	value: AnnotatorAppSessionState['exportSettings']['exportBackground']
	onChange(
...
function ExportFormatSelect({
	...
	value: AnnotatorAppSessionState['exportSettings']['exportFormat']
	onChange(
		key: 'exportFormat',
		value: AnnotatorAppSessionState['exportSettings']['exportFormat']
	): void
...
function ExportThemeSelect({
	...
	value: AnnotatorAppSessionState['exportSettings']['exportTheme']
	onChange(key: 'exportTheme', value: AnnotatorAppSessionState['exportSettings']['exportTheme']): void
}) {
...
async function getEditorImage(
	editor: Editor,
	shapes: TLShape[],
	preferences: AnnotatorAppSessionState['exportSettings'],
...
function getExportPreferences(app: AnnotatorApp | null) {
