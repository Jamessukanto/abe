...
export class AnnotatorApp {
	...
	messages = defineMessages({
		...
		client_too_old: {
			defaultMessage: 'Please refresh the page to get the latest version of annotator.',
		},
		max_files_title: {
	...
	static async create(opts: {
		...
		const app = new AnnotatorApp(opts.userId, opts.getToken, opts.onClientTooOld, opts.trackEvent)
		// @ts-expect-error
		window.app = app
