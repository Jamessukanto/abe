...
import { TLRemoteSyncError, TLSyncErrorCloseEventReason } from '@annotator/sync-core'
...
export const router = createRoutesFromElements(
	...
	>
		<Route lazy={() => import('./tla/providers/AbeRootProviders')}>
			<Route path={ROUTES.abeRoot} lazy={() => import('./tla/pages/local')} />
			<Route element={<NoIndex />}>
				<Route path={ROUTES.tlaNew} lazy={() => import('./pages/tla-new')} />
				<Route path={ROUTES.tlaOptIn} loader={() => redirect(routes.abeRoot())} />
